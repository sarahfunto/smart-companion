...
1. Missing or Vague Operational Facts (Industry, Size, Tools):
   - Ask a direct clarification question with 2-4 concrete options.
2. Operational Pain known, BUT Executive Fear / Business Consequence missing (CRITICAL STEP):
   - DO NOT stop after learning the pain point. You must explore the business impact.
   - Example pattern: "When you encounter [stated pain], what is the primary business risk or fear from your perspective? Does it mainly affect budget allocation, your ability to demonstrate ROI to leadership, or strategic growth decisions?"
                ...
                with st.spinner("Thinking..."):
                    ...
                    if not gatekeeper_is_unlocked:
                        system_instruction += (
                            ...
                            "You MUST ask a targeted question to uncover the missing fields (specifically Executive Fear / Business Impact if pain is known)."
                        )
                    else:
                        system_instruction += (
                    ...
                    if not gatekeeper_is_unlocked and ("gathered all key insights" in reply.lower() or "generate human diagnostic report" in reply.lower()):
                        ...
                        if not has_fear:
                            ...
                            reply = (
                                "Thank you. To complete our strategic picture, is there a specific market event or internal deadline "
                                "that makes solving this priority urgent right now?"
                            )
